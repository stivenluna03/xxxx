...
package igu;
import javax.swing.*;
public class Pconfirmar extends javax.swing.JFrame {
    public Pconfirmar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pconfirmar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pconfirmar().setVisible(true);
            }
        });
    }
